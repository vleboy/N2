  ...
  <div class="login">
    ...
    <div class="page-wrapper">
      ...
      <div class="login-right">
        <Form label-position="left" :label-width="80" :model="formValidate" ref="formValidate">
...
import { validateUsername, validatePwd } from "@/config/regexp";
export default {
  data() {
    return {
      formValidate: {
  ...
  methods: {
    ...
    getCode() {
      this.loadImg = true;
      httpRequest("post", "/xserver/agent/captcha", {
        userName: `${this.formValidate.username}`
      })
        .then(res => {
          this.showCode = false;
          this.codeSrc = "data:image/png;base64," + res.res;
        })
        .finally(() => {
          this.loadImg = false;
        });
...
.animation-wrapper {
  ...
  width: 100%;
  height: 100%;
  background: #1e1e1e bottom center;

    ...
    >
      <div>
        <Row class-name="content">
          ...
          <Col span="18">
            <Input v-model="userName" placeholder="Enter something..." style="width: 100%" />
          </Col>
        </Row>
        <Row class-name="content">
          <Col span="6" class-name="tc">代理密码:</Col>
          <Col span="18">
            <Input v-model="userPwd" placeholder="Enter something..." style="width: 100%" />
          </Col>
        </Row>
        <Row class-name="content">
          <Col span="6" class-name="tc">代理昵称:</Col>
          <Col span="18">
            <Input v-model="userNick" placeholder="Enter something..." style="width: 100%" />
          </Col>
        </Row>
      </div>
...
export default {
  ...
  computed: {
    listenshowDraw() {
      return this.$store.state.agent.createAgent;
    },
  },
  methods: {
    hideDraw() {
